const DOWNLOAD_URL = "./downloads/xiaojing-accounting-0.1.2-windows-x64-setup.exe";
...
const translations = {
  zh: {
    ...
    backHome: "返回官网",
    tagline: "AI 办公搭子",
    description: "面向财务与日常办公的 AI 桌面助手，让资料、任务与智能协作在一个工作空间内完成。",
  ...
  en: {
    ...
    description: "An AI desktop assistant for finance and everyday work, bringing files, tasks, and intelligent collaboration into one workspace.",
